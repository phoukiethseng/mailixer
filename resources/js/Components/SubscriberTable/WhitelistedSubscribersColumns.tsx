...
export const columns: ColumnDef<Subscriber>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const formatted = new Date(Date.parse(createdAt)).toLocaleDateString()
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action will move selected subscriber to blacklist and
                      this subscriber won't be able to receive any more
                      newsletter.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter className="flex flex-row start gap-3">
                    ...
                    <AlertDialogAction
                      onClick={() =>
                        router.put(`/dashboard/blacklistSubscriber/`, {
                          id: row.getValue('id'),
                        })
                      }
                    >
