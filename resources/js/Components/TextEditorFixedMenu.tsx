...
const TextEditorFixedMenu = ({
  ...
  return (
    <div
      className={
        'border border-border bg-background rounded-md mt-4 flex flex-row gap-1 justify-center items-center px-1.5 py-1'
      }
    >
      <Button
      ...
      <Dialog open={isImageDialogOpen} onOpenChange={setIsImageDialogOpen}>
        ...
        <DialogContent>
          <UploadImage
            onImageFileSelectionChange={handleImageUpload}
