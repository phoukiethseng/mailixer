...
export default function SettingsPage(props: SettingsPageProps) {
  ...
  useServerValidationErrorMessage<z.infer<typeof profileFormZod>>(
    profileForm,
    'profile',
    props
  )
  useServerValidationErrorMessage<z.infer<typeof accountFormZod>>(
    accountForm,
    'account',
    props
  )

  const currentProfilePicture = useWatch({
    name: 'profilePicture',
  ...
  const [currentProfilePictureType, setCurrentProfilePictureType] =
    useState<string>(props.account.profilePictureType)
  ...
  function handleProfileFormSubmit(data: z.infer<typeof profileFormZod>) {
    ...
    const formData = {
      ...
      profilePictureType: profilePictureHasChanged
        ? currentProfilePictureType
        : undefined,
    }
  ...
  const tabsTriggerClassName =
    'justify-start data-[state=active]:bg-secondary data-[state=active]:shadow-none py-2.5'
  const formClassName =
    'pt-3 pl-5 gap-3 flex flex-col justify-start items-start'
  const onBackButtonClick: MouseEventHandler<HTMLButtonElement> = (e) => {
    router.visit('/dashboard/customize_page')
  }
  const newPasswordFieldIsDirty =
    accountForm.getFieldState('newPassword').isDirty
  return (
          ...
          <Tabs defaultValue={'profile'}>
            <ResizablePanelGroup direction={'horizontal'}>
              <ResizablePanel defaultSize={17} minSize={20} maxSize={25}>
                <TabsList
                  className={
                    'w-full min-h-[80vh] mt-3 pr-2.5 gap-1 flex flex-col justify-start items-stretch bg-background'
                  }
                >
                  <TabsTrigger
                ...
                <ScrollArea>
                          ...
                          render={({ field }) => {
                            ...
                            return (
                              <FormItem>
                                ...
                                <Avatar
                                  className={
                                    'w-[110px] h-[110px] border-2 shadow-md border-primary '
                                  }
                                >
                                  <AvatarImage
                                    src={field.value}
                                ...
                                <FormDescription>
                                  Your profile picture. Maximum size is 1MB
                                </FormDescription>
                                <FormMessage />
                                <Dialog
                                  open={isDialogOpen}
                          ...
                          render={({ field }) => {
                            return (
                              <FormItem className={'min-w-[200px]'}>
                                ...
                                <FormDescription>
                                  Your display name. This will also show up on
                                  your subscribe page as well.
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )
                  ...
                  <TabsContent value={'account'}>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Edit your account's credentials
                      </CardDescription>
                    </CardHeader>
                    <Separator />
                    <Form {...accountForm}>
                      ...
                      >
                          ...
                          render={({ field }) => {
                            return (
                              <FormItem className={'min-w-[200px]'}>
                                ...
                                <Input {...field} />
                                <FormDescription>
                                  Your account's email. This will be used for
                                  login
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                        ...
                        />
                        <FormField
                          disabled={!newPasswordFieldIsDirty}
                          name={'oldPassword'}
                          render={({ field, fieldState }) => {
                            return (
                              <FormItem className={'min-w-[200px]'}>
                                ...
                                <Input {...field} type={'password'} />
                                <FormDescription>
                                  Enter your old password in order to change
                                  your password
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
