            ...
            <ResizablePanel minSize={30} maxSize={50} defaultSize={35} className={"flex flex-col gap-3"}>
                {
                    draftNewsletters.map((newsletter, index) => {
                        ...
                        return (
                            <Card key={index} className={cn("py-3 hover:bg-muted group/draftcard", (currentPreviewNewsletter ? currentPreviewNewsletter.id === newsletter.id : false) && "border-primary")}
