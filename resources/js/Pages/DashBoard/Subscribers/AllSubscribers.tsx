  ...
  return (
    ...
    >
      <ResizablePanel minSize={20} maxSize={50} defaultSize={30} className={''}>
        <div
          className={
            'w-full flex flex-row justify-center items-start flex-wrap gap-4'
          }
        >
          <div
            className={'flex flex-row gap-3 flex-wrap justify-stretch'}
          ></div>
          <Card>
            <CardHeader>
...
SubscribersPage.layout = (page: React.ReactNode) => (
  <NewDashBoardLayout activeSubPageName={'Subscribers'}>
    {page}
  </NewDashBoardLayout>
)
